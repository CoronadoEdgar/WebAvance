...
<html>
    ...
    <section class="full-width pageContent">
        ...
        <section class="full-width header-well"> 
            <div class="full-width header-well-text" style="align-content: center">
                <h2>CLIENTES</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="Controlador?menu=Cliente" method="POST">
                            ...
                            <div class="form-group">
                                <label>Mail</label>
                                <input type="text" value="${cliente.getMail()}" name="txtMail" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Estado</label>
