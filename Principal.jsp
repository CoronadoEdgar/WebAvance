    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-info">           
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Web.html" target="myFrame">home</a>
                    </li>
                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Cita&accion=Listar" target="myFrame">Citas</a>
                    </li>
