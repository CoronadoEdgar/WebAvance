                ...
                <div class="card">
                    <div class="card-body">
                        <form action="Controlador?menu=Proveedor" method="POST">
                            ...
                            <div class="form-group">
                                <label>Estado</label>
                                <input type="text" value="${proveedor.getEst()}" name="txtEst" class="form-control">
                            </div>                        
                            ...
                            <tbody> 
                                <c:forEach var="em" items="${proveedores}">
                                    <tr>
                                        ...
                                        <td>${em.getEst()}</td>                                        
                                        <td>
                                            <a class="btn btn-warning" href="Controlador?menu=Proveedor&accion=Editar&id=${em.getIdProv()}">Editar</a>
                                            <a class="btn btn-danger" href="Controlador?menu=Proveedor&accion=Delete&id=${em.getIdProv()}">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
