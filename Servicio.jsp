                    ...
                    <div class="card-body">
                        <form action="Controlador?menu=Servicio" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" value="${servicio.getNom()}" name="txtNombre" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>PRECIO</label>
                                <input type="text" value="${servicio.getPre()}" name="txtPrecio" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>ESTADO</label>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody> 
                                <c:forEach var="em" items="${servicios}">
                                    <tr>
                                        <td>${em.getIdSer()}</td>
                                        <td>${em.getNom()}</td>
                                        <td>${em.getPre()}</td>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="Controlador?menu=Servicio&accion=Editar&id=${em.getIdSer()}">Editar</a>
                                            <a class="btn btn-danger" href="Controlador?menu=Servicio&accion=Delete&id=${em.getIdSer()}">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
