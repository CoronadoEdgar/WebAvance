                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="codigoempleado" value="${empleado.getId()}" class="form-control" placeholder="Codigo">
                                    <button type="submit" name="accion" value="BuscarEmpleado" class="btn btn-outline-info">Buscar</button>
                                </div>                           
                                <div class="col-sm-6">
                                    <input type="text" name="empleados" value="${empleado.getNom()}" placeholder="Datos Empleado" class="form-control">
                                </div>                           
                            </div>
                            <!--DATOS DEL PRODUCTO-->
                            <div class="form-group">
                          ...
                          <div class="d-flex ml-auto col-sm-6">
                            ...
                            <% 
                                ...
                                //SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("dd-MM-yy");
                                    String MMddyyyyToday =Date.format(today);
                            %>
                            <label class="text-right mt-1 col-sm-4">Fecha</label>
                            <input readonly="" type="text" name="empleados" class="form-control text-center" value="${MMddyyyyToday}" style="font-weight: bold;font-size: 18px">
                        </div> 
                        <div class="d-flex ml-auto col-sm-6">
                            
                            <label class="text-right mt-1 col-sm-4">Empleado</label>
                            <input readonly="" type="text" name="empleados" class="form-control text-center" value="${empleado.getNom()}" style="font-weight: bold;font-size: 18px">
                        </div>  
                        <div class="d-flex ml-auto col-sm-6">
